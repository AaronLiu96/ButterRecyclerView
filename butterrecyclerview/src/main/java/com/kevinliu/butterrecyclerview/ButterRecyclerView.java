package com.kevinliu.butterrecyclerview;
 ...
 * Function：
 */
public class ButterRecyclerView extends FrameLayout {
    ...
    public ButterRecyclerView(Context context) {
        super(context);
        initView();
    }

    public ButterRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public ButterRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Remove tche adapter from the reycler
     */
    public void clear() {
